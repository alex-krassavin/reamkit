...
import type { Hyphenator } from '@/hyphenation/liang';
import { createHyphenator, splitPatternBundle } from '@/hyphenation/liang';

export type { Hyphenator, HyphenatorOptions } from '@/hyphenation/liang';
export { createHyphenator, splitPatternBundle } from '@/hyphenation/liang';
...
const REGISTRY: Record<SupportedLanguage, LanguageDescriptor> = {
  'en-us': {
    leftMin: 2,
    rightMin: 3,
    load: () => import('@/hyphenation/patterns-en-us'),
  },
  ru: {
    leftMin: 2,
    rightMin: 2,
    load: () => import('@/hyphenation/patterns-ru'),
  },
};
