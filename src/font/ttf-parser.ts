...
import type { ArabicJoiningForms, KerningMap, LigatureMap } from '@/font/opentype-layout';
import { BigEndianReader } from '@/font/binary-reader';
import { parseGposKerning, parseGsubArabicForms, parseGsubLigatures } from '@/font/opentype-layout';
