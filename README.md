...
paragraph formatting), embedded images, and per-shape placement (anchored text
boxes and pictures positioned at their slide rectangles), one page per slide — all
