...
**Статус: D1–D7 ✅ (текстовый writer покрывает реальный документ; гейт зелёный).**
Roundtrip-гейт: 940 корпус-доков, **ноль writer-падений**, POI 94% / LO 98% полная IR-идентичность.
D7 закрыл многосекционность (per-section sectPr: mid-doc в pPr закрывающего параграфа, финальная —
body-child; HF per-section с дедупом) → LO ⚠️35→18. Остаточные v1-пробелы (честные): форматы
картинок GIF/EMF/WMF, сноски/чарты/шейпы/math → лоссы, краевые ±1 параграф (SDT+картинка и т.п.).
