...
**Статус: D1–D6 ✅ (текстовый writer покрывает реальный документ; гейт зелёный).**
D6 roundtrip-гейт: 940 корпус-доков, **ноль writer-падений**, 96% полная IR-идентичность.
Документированные v1-пробелы (вскрыты гейтом): многосекционность (пишется только 1-я секция),
неподдерживаемые форматы картинок (GIF/EMF/WMF), сноски/чарты/шейпы/math → лоссы.
