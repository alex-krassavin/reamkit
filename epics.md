...
- **SD2 ✓ — roundtrip-гейт** (`f8ab727`). xlsx→SheetDoc→xlsx→SheetDoc: IR-идентичность written-surface +
  байт-стабильность (`b2===b1`, детерминированный fixpoint). 14 фикстур.
- **SD3+ — хвосты паритета.** Write-back page setup / print options / breaks / условного форматирования /
  спарклайнов / table-партов (сейчас reported as losses); опц. цельный xlsx-корпус-гейт.
